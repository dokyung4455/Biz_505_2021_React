...
// ./component/hello.js 파일을 Hello 라는 컴포넌트객체로 선언하기
// 사용자 정의형(개발자가 임의로 만든) 컴포넌트를 사용하기 위해
// import 할때는 이름의 첫글자를 대문자로 사용한다.
// react를 사용하는 과정에서 react 자체적으로 제공하는 컴포넌트와 혼동되거나 충돌하는 것을 방지하기 위함이다.
import Hello from "./components/hello.js";

/*
HTML의 h1 tag를 사용하여 반갑습니다 문자열을 표현하는 컴포넌트를 선언하기
